...
train_model.py
--------------
Trains a CNN on the FER2013 dataset and saves the Keras model.

Usage:
    1. Download fer2013.csv from Kaggle:
       https://www.kaggle.com/datasets/msambare/fer2013
    2. Place fer2013.csv in this (training/) directory.
    3. Run:  python train_model.py
    4. Output: emotion_model.h5  (in this directory)
"""
...
def load_fer2013(csv_path: str):
    ...
    # Split by the 'Usage' column if present, otherwise do 80/10/10
